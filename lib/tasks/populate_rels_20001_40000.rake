namespace :db do
	task :populate_rels_20001_40000 => :environment do
		puts "Adding relationships 20001-40000..."
	    inFile = File.new("lib/data/Relationships20001-40000.tsv",'r')
	    count = 20001
	    ...
	    inFile.each { |line|
	     ...
	     puts count
	    inFile.close
	    puts "Finished adding relationships 20001-40000"
	end
end