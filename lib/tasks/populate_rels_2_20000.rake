namespace :db do
	task :populate_rels_2_20000 => :environment do
		puts "Adding relationships 2-20000..."
	    inFile = File.new("lib/data/Relationships2-20000.tsv",'r')
	    count = 2
	    #start the id  at 100,000,000, set manually
	    next_id = 100000000
	    puts inFile
	    inFile.each { |line|
	      data = line.split('\n')      
	     ...
	     puts count
	    inFile.close
	    puts "Finished adding relationships 2-20000"
	end
end