namespace :db do
	task :populate_rel_start_end_date_109862_120000 => :environment do 
    	...
    	problem_list2 = [100109873, 100109842,100080800,100109862, 100109845,100064218,100109877,100109854,100109857,100081744,100096324,100109836,100039642,100096253,100084021,100109860, 100109881, 100036033,100109837,100109871,100109882]
    	for i in 100109862..100120000
    		if (! problem_list.include?(i))
    			if (! problem_list2.include?(i))
