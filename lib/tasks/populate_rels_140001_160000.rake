namespace :db do
	task :populate_rels_140001_160000 => :environment do
		puts "Adding relationships 140001_160000..."
	    inFile = File.new("lib/data/Relationships140001-160000.tsv",'r')
	    count = 140001
	    ...
	    inFile.each { |line|
	     ...
	     puts count
	    inFile.close
	    puts "Finished adding relationships 140001_160000"
	end
end