namespace :db do
	task :populate_rels_120001_140000 => :environment do
		puts "Adding relationships 120001-140000..."
	    inFile = File.new("lib/data/Relationships120001-140000.tsv",'r')
	    count = 120000
	    puts inFile
	    inFile.each { |line|
	      data = line.split('\n')
	     ...
	     puts count
	    inFile.close
	    puts "Finished adding relationships 120001-140000"
	end
end