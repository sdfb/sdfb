namespace :db do
	task :populate_rels_40001_60000 => :environment do
		puts "Adding relationships 40001_60000..."
	    inFile = File.new("lib/data/Relationships40001-60000.tsv",'r')
	    count = 40001
	    ...
	    inFile.each { |line|
	     ...
	     puts count
	    inFile.close
	    puts "Finished adding relationships 40001_60000"
	end
end