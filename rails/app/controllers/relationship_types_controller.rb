class RelationshipTypesController < ApplicationController
  ...
  def show
    ...
    @rel_cat_assigns_approved = RelCatAssign.all_approved.for_rel_type(params[:id]).order_by_sdfb_id.paginate(:page => params[:rel_cat_assigns_approved_page]).per_page(100)
