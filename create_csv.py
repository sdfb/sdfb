...
def make_nodelist(current_time, dict_cur):
    ...
    filename = '/var/www/sdfb/angular/app/data/SDFB_people_{}.csv'.format(current_time)
...
def make_edgelist(current_time, dict_cur):
    ...
    filename = '/var/www/sdfb/angular/app/data/SDFB_relationships_{}.csv'.format(current_time)
    with open(filename, 'w') as output_file:
        dict_writer = csv.DictWriter(output_file, keys)
        dict_writer.writeheader()
...
def make_grouplist(current_time, dict_cur):
    ...
    filename = '/var/www/sdfb/angular/app/data/SDFB_groups_{}.csv'.format(current_time)
    with open(filename, 'w') as output_file:
        dict_writer = csv.DictWriter(output_file, keys)
        dict_writer.writeheader()
        dict_writer.writerows(edge_dicts)
...
def make_groupassignments(current_time, dict_cur):
    ...
    filename = '/var/www/sdfb/angular/app/data/SDFB_group_assignments_{}.csv'.format(current_time)
    with open(filename, 'w') as output_file:
        dict_writer = csv.DictWriter(output_file, keys)
        dict_writer.writeheader()
        dict_writer.writerows(edge_dicts)
...
def make_relationshiptypes(current_time, dict_cur):
    ...
    filename = '/var/www/sdfb/angular/app/data/SDFB_relationship_types_{}.csv'.format(current_time)
    with open(filename, 'w') as output_file:
        dict_writer = csv.DictWriter(output_file, keys)
        dict_writer.writeheader()
        dict_writer.writerows(edge_dicts)
