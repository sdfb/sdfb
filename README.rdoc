Total records = uncertain+unlikely+possible+likely+certain
77659 = 19670+20255+24463+9692+3489
...
rake db:populate
rake db:populate_rel_certain
rake db:populate_rel_likely
rake db:populate_rel_possible
rake db:populate_rel_uncertain
rake db:populate_rel_unlikely
