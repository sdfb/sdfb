module PeopleHelper
  ...
  def update_rels(person1_index, person2_index, average_certainty, is_approved)
    ...
    #     rel_array = []
    #     rel_array.push(person2_index, average_certainty, is_approved)
    #   else
    ...
    person1_current_rel_sum.each do |rel_record_1|
      if rel_record_1[0] == person2_index
        rel_record_1[1] = average_certainty
    ...
    if person1_updated_flag == false
    	...
    	person1_current_rel_sum.push(person2_index, )
    end
    ...
    #     rel_array = []
    #     rel_array.push(person1_index, average_certainty, is_approved)
    #   else
    ...
    person2_current_rel_sum.each do |rel_record_2|
      if rel_record_2[0] == person1_index
        rel_record_2[1] = average_certainty
