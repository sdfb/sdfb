  ...
  def export_rel_type_assigns_00000_20000
    ...
    if (current_user.user_type == "Admin")
      user_rel_contribs_csv = CSV.generate do |csv|
          csv << ["SDFB Relationship Type Assignment ID", "SDFB Relationship ID", "SDFB Relationship Type ID", "Confidence", "Start Date Type", "Start Month", "Start Day", "Start Year", "End Date Type", "End Month", "End Day", "End Year", "Justification", "Citation", "Created By ID", "Created At", "Is approved?", "Approved By ID", "Approved On"]
          @all_user_rel_contribs.each do |user_rel_contrib|
              csv << [user_rel_contrib.id, user_rel_contrib.relationship_id,
              user_rel_contrib.relationship_type_id, user_rel_contrib.certainty, 
      ...
      user_rel_contribs_csv = CSV.generate do |csv|
        csv << ["SDFB Relationship Type Assignment ID", "SDFB Relationship ID", "SDFB Relationship Type ID", "Confidence", "Start Year Type", "Start Month", "Start Day", "Start Year", "End Date Type", "End Month", "End Day", "End Year"]
