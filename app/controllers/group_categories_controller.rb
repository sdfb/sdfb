class GroupCategoriesController < ApplicationController
  ...
  def index
    @group_categories_approved = GroupCategory.all_approved.order_by_sdfb_id.paginate(:page => params[:group_category_approved_page]).per_page(30)
  ...
  def show
    ...
    @group_cat_assigns_approved = GroupCatAssign.for_group_category(params[:id]).all_approved.order_by_sdfb_id.paginate(:page => params[:group_cat_assigns_approved_page]).per_page(30)
