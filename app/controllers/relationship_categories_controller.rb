class RelationshipCategoriesController < ApplicationController
  ...
  def index
    @relationship_categories = RelationshipCategory.all_approved.paginate(:page => params[:rel_category_approved_page]).per_page(30)
  ...
  def show
    ...
    @rel_cat_assigns_approved = RelCatAssign.all_approved.for_rel_cat(params[:id]).paginate(:page => params[:rel_cat_assigns_approved_page]).per_page(30)
