...
$(document).ready(function() {
    ...
    $("#edge-annotate").tooltip({placement: 'right', title: 'These percentages were inferred by statistically analyzing the Oxford Dictionary of National Biography. See blog for more information.'});
